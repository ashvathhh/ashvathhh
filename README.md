...
**ML/AI:** PyTorch, TensorFlow, Keras, Scikit-learn, Hugging Face, OpenCV, YOLOv8, LangChain  
**Languages:** Python, JavaScript, SQL  
**Data:** Pandas, NumPy, Matplotlib, Seaborn, Plotly  
**Databases:** MySQL, PostgreSQL, MongoDB, Firebase  
**Cloud & DevOps:** AWS (EC2, S3, Lambda), Google Cloud, Docker, Git, CI/CD  
**Tools:** FastAPI, Flask, React, Node.js

## Experience

**AI Intern** @ Skillible *(Jul 2024 – Aug 2024)*  
Investigated bias-mitigation strategies for generative AI models and developed prompt templates to improve LLM output quality.

**Web Development Intern** @ Anugraha Systems *(Jan 2023)*  
Built full-stack web applications in React and MySQL. Shipped a real-time customer-facing dashboard.
...
cheppalli.a@northeastern.edu  
[LinkedIn](https://www.linkedin.com/in/ashvath-cheppalli-0ab28a249) · [Portfolio](https://ashvathhh.github.io/Profile/)
